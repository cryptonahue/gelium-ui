...
func TestCardTemplateSlotGuards(t *testing.T) {
	tmpl := repositoryFile(t, "site", "web", "templates", "card.html")
...
func renderCardPrimitive(t *testing.T, data cardSlotData) string {
	t.Helper()
	cardHTML := repositoryFile(t, "site", "web", "templates", "card.html")
	buttonHTML := repositoryFile(t, "site", "web", "templates", "button.html")
