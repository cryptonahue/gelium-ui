...
The curated allowlist: `add`, `arrow_back`, `arrow_downward`, `arrow_forward`, `arrow_upward`, `check`, `chevron_left`, `chevron_right`, `close`, `delete`, `edit`, `error`, `home`, `info`, `menu`, `more_vert`, `refresh`, `save`, `search`, `settings`, `warning`.
