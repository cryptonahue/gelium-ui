...
Use a toast when an action completes server-side and the result should be announced in place — a save confirmation, an error, a status change — without pushing users to another view.
