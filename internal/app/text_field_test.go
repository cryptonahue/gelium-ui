...
func TestTextFieldFormAndLocalScriptImplementHTMX422SwapContract(t *testing.T) {
	...
	htmxIndex := strings.Index(body, `src="/static/htmx.min.js?v=0.5.5"`)
	geliumIndex := strings.Index(body, `src="/static/gelium.js?v=0.5.5"`)
	appIndex := strings.Index(body, `src="/static/app.js?v=0.5.5"`)
