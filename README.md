...
Current release: **v0.6.3** — [npm `gelium-ui`](https://www.npmjs.com/package/gelium-ui) published; monorepo `lib/` + `site/` dogfood; HTMX 4; on-this-page rail; prev/next pagination; demo-first docs; mobile foundations (touch targets, safe areas, reduced motion, overflow containment).
