...
```text
name:           Gelium UI
softwareVersion: 0.6.3        (source: lib.AssetsVersion / lib/package.json)
...
```text
Gelium UI documentation · v0.6.3 · MIT license
...
- **Visible version**: header/footer shows `Gelium UI v0.6.3` on every docs-shell page from `lib.AssetsVersion`; assets keep `?v={{.AssetsVersion}}`.
